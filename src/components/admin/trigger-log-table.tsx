...
export function TriggerLogTable({
  ...
  const hasFilters =
    searchLocal !== '' || workflowFilterLocal !== 'all' || companyFilterLocal !== 'all' || statusFilterLocal !== 'all';
              ...
              {logs.map((log) => (
                <TableRow key={log.id}>
                  ...
                  <TableCell className="text-right">
                    <Button variant="outline" size="sm" onClick={() => router.push(`/trigger-history/${log.id}`)}>
