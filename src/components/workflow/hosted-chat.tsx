  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>{workflow.description || t('workflowTypeChat')}</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <p className="text-sm text-muted-foreground">
          {t('openHostedChatDescription', {
            defaultMessage: 'Click the button below to open the hosted AI chat interface.',
          })}
        </p>
